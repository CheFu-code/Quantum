...
import type { ChatComposerProps, ImageAttachment } from "../_lib/types";
...
export function ChatComposer({
    ...
    return (
        ...
        >
            ...
            <div
                className={`pointer-events-auto mx-auto w-full ${variant === "landing" ? "max-w-206.5" : "max-w-3xl"
                    }`}
            >
                <div className="relative">
                            ...
                            >
                                ...
                                {MODELS.map((model) => (
                                    <button
                                        ...
                                        className={`flex w-full items-center gap-3 px-4 py-3 text-left transition ${selectedModel.id === model.id
                                            ? "bg-primary/10"
                                            : "hover:bg-muted/55"
                                            }`}
                                    >
                    ...
                    <div
                        className={`rounded-4xl border border-border bg-card/95 shadow-2xl shadow-black/20 backdrop-blur transition focus-within:border-primary/45 ${variant === "landing" ? "px-4 py-3" : "px-3 py-2.5 sm:px-4"
                            }`}
                    >
                ...
                {inputNotice && (
                    <p className="mt-2 text-center text-[11px] text-chart-3">
                        {inputNotice}
                    </p>
                )}
                {variant === "dock" && (
...
function AttachmentChip({
    ...
    return (
        <div className="flex max-w-45 shrink-0 items-center gap-2 rounded-full border border-border bg-muted/45 py-1 pl-2 pr-1 text-xs text-foreground/85">
...
function IconButton({
    ...
    return (
        <button
            ...
            disabled={disabled}
            onClick={onClick}
            className={`flex size-10 shrink-0 items-center justify-center rounded-full transition disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-transparent ${active

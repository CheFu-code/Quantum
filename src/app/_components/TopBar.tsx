    ...
    <>
      <header className="relative z-30 flex h-[68px] shrink-0 items-center gap-3 px-3 sm:h-20 sm:px-6">
        <button
          ...
          className={`flex size-10 shrink-0 items-center justify-center rounded-full text-muted-foreground transition hover:bg-muted/55 hover:text-foreground ${
            sidebarOpen ? "md:pointer-events-none md:opacity-0" : ""
          }`}
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            className="hidden size-10 items-center justify-center rounded-full text-muted-foreground transition hover:bg-muted/55 hover:text-foreground sm:flex"
            title="Settings"
          >
            <Settings size={18} />
          </button>
...
function MenuItem({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`flex w-full items-center gap-2 rounded-2xl px-3 py-2 text-sm transition disabled:cursor-not-allowed disabled:opacity-40 ${
        danger
